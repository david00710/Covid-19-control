...
plt.tight_layout()
plt.savefig('case_shield_phi1a.png')
plt.show()
...
plt.tight_layout()
plt.savefig('case_shield_phi1b.png')
plt.show()
...
plt.savefig('case_shield_phi1c.png')
plt.show()
...
plt.tight_layout()
plt.axhline(0.003, color='r', linestyle=':')
plt.savefig('case_shield_phi1d.png')
plt.show()
