...
plt.tight_layout()
plt.savefig('case_quarantine_phi3a.png')
plt.show()
...
plt.tight_layout()
plt.savefig('case_quarantine_phi3b.png')
plt.show()
...
plt.tight_layout()
plt.axhline(0.03, color='r', linestyle=':')
plt.savefig('case_quarantine_phi3c.png')
plt.show()
...
plt.tight_layout()
plt.axhline(0.0005, color='r', linestyle=':')
plt.savefig('case_quarantine_phi3d.png')
plt.show()